import{a as P}from"./chunk-TIUQE2UG.js";import{a as c,b as x}from"./chunk-KUNVXXL6.js";import{K as n,Q as u,S as d,W as A,Z as k,_ as m}from"./chunk-7KQMPMLH.js";import{H as j,P as L,T,Y as E,aa as p,e as S,ha as $,x as O,y as _}from"./chunk-TU3JDJEI.js";var D=function(e){return e.approve="approved",e.bought="bought",e.borrow="borrowed",e.burn="burnt",e.cancel="canceled",e.claim="claimed",e.deploy="deployed",e.deposit="deposited",e.execute="executed",e.mint="minted",e.receive="received",e.repay="repaid",e.send="sent",e.sell="sold",e.stake="staked",e.trade="swapped",e.unstake="unstaked",e.withdraw="withdrawn",e}(D||{});var U=d`
  :host > wui-flex {
    display: flex;
